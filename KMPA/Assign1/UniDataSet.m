...
% %% Paths of Dataset
% 
filePath = '/Users/jomkuriakose/Courses/Kernel/Assignment/Assign1/data/univariateData/';
% 
...
%     xlabel('log lamda','fontsize',15);
%     ylabel('Error-MSE','fontsize',15);
%     hold off;
% end
...
%     title(str,'fontsize',15);
%     xlabel('Model Complexity, M','fontsize',15);
%     ylabel('Error-MSE','fontsize',15);
%     hold off;
% end
