#!/usr/bin/env python2
"""
Classifier based on Special getTermDocMatrix

*	Added the tag NOT to every word between a negation word
	(eg: “not”) and the first punctuation mark following 
	the negation word.
...
def loadData():
	...
	dataReader.setTerms(2000,featureSelection='PD')
